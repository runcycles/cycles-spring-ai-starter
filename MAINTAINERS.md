...
This document lists the people responsible for triaging issues, reviewing PRs, and cutting releases for `cycles-spring-ai-starter` (the `io.runcycles:cycles-spring-ai-starter` artifact on Maven Central).
...
| Spring AI version bumps | Project lead | Track Spring AI 1.x line; 2.x bumps require explicit API review |
...
- **General questions / bug reports**: [GitHub Issues](https://github.com/runcycles/cycles-spring-ai-starter/issues)
